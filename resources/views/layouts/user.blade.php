...
<body class="bg-gray-50 min-h-screen font-sans" x-data="{ mobileMenuOpen: false }">
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="md:pl-64 flex flex-col flex-1">
                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center py-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <!-- Notifications -->
                            <div class="relative">
                                <button class="p-2 text-indigo-600 hover:text-indigo-700 hover:bg-indigo-50 rounded-lg transition-colors relative" id="notifications-button">
                                ...
                                <div class="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg py-1 ring-1 ring-black ring-opacity-5 hidden transform transition-all duration-200 origin-top-right" id="notifications-menu">
                            ...
                            <div class="relative">
                                <button type="button" class="flex items-center space-x-3 p-2 text-sm font-medium text-purple-600 hover:text-purple-700 hover:bg-purple-50 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2" id="user-menu-button">
                                ...
                                <!-- Dropdown Menu -->
                                <div class="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg py-1 ring-1 ring-black ring-opacity-5 hidden transform transition-all duration-200 origin-top-right" id="user-menu">
            ...
            <!-- Mobile Sidebar -->
            <div class="md:hidden hidden fixed inset-0 flex z-40" id="mobile-menu">
                ...
                <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
                    ...
                    <div class="border-t border-gray-200 p-4">
                        <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-4 border border-blue-100">
                            ...
                            <button class="w-full mt-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 shadow-sm">
                                Buy Credits
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="flex-shrink-0 border-t border-gray-200 p-4">
                        <div class="flex items-center justify-between">
                            ...
                            <button class="p-2 text-gray-400 hover:text-gray-600 rounded-lg" id="mobile-profile-menu">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-3 space-y-1 hidden" id="mobile-profile-dropdown">
